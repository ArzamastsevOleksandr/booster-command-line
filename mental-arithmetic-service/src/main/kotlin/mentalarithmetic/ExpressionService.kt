...
class ExpressionService {
    ...
    fun generate(level: Int): api.arithmetic.ArithmeticExpression {
    ...
    private fun generate(level: Int, expressionType: ChallengeType): api.arithmetic.ArithmeticExpression {
    ...
    private fun multiplication(level: Int): api.arithmetic.ArithmeticExpression {
        return api.arithmetic.ArithmeticExpression.builder()
