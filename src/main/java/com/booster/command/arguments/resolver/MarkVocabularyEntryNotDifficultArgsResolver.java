...
public class MarkVocabularyEntryNotDifficultArgsResolver implements ArgsResolver {
    ...
    public CommandWithArguments resolve(List<String> args) {
        ...
        try {
            ...
            return builder.args(new MarkVocabularyEntryNotDifficultArgs(Long.parseLong(flag2value.get(ID_FLAG))))
                    .build();
